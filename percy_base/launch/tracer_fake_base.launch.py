...
def generate_launch_description():
    ...
    port_name_arg = DeclareLaunchArgument('port_name', default_value='vcan0',
                                         description='CAN bus name, e.g. vcan0')
    ...
    is_percy_mini_arg = DeclareLaunchArgument('is_percy_mini', default_value='false',
    ...
    percy_base_node = launch_ros.actions.Node(
        package='percy_base',
        executable='percy_base_node',
        output='screen',
        emulate_tty=True,
        parameters=[{
                ...
                'is_percy_mini': launch.substitutions.LaunchConfiguration('is_percy_mini'),
